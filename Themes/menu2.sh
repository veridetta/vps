...
# status
rm -rf /root/status
wget -q -O /root/status "https://raw.githubusercontent.com/veridetta/vps//main/statushariini"
...
CEKEXPIRED () {
        ...
        Exp1=$(curl -sS https://raw.githubusercontent.com/veridetta/vps//main/izin | grep $MYIP | awk '{print $3}')
        if [[ $today < $Exp1 ]]; then
...
echo "Akses di tolak!! Silahkan hubungi adminsitrator.";
exit 0
fi
...
Exp=$(curl -sS https://raw.githubusercontent.com/veridetta/vps//main/izin | grep $MYIP | awk '{print $3}')
fi
...
echo -e "□ AutoScript By       =  ${GREEN}( Shinobi Konoha )${NC}"
...
echo -e "${ungu}└───────────────────────────────────────────────┘${NC}"
echo -e "${CYAN}                  🦝V.1.0.0 LTS🦝"
echo -e ""
echo -e "${ungu}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${CYAN}                   ⇱ Shinobi Konoha ⇲          ${NC}"
echo -e "${ungu}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e ""
