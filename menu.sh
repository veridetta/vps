...
echo "Akses di tolak!! Mohon hubungi administrator!!";
exit 0
fi
# // Root Checking
if [ "${EUID}" -ne 0 ]; then
...
echo -e "${GREEN}| \E[44;1;39m         *Script Executive ShinobiKonoha* \E[0m|"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
...
echo -e "${GREEN}│ ${BOLD}${LIGHT}Developer = ShinobiKonoha                   ${NC}"
echo -e "${GREEN}│ ${BOLD}${LIGHT}Version   = 1.0.0 LTS                       ${NC}"
